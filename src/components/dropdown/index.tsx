    ...
    return (
      <Menu as='div' className='relative inline-block text-left'>
        ...
        <Transition
          ...
          <Menu.Items className='absolute right-0 mt-2 w-56 origin-top-right divide-y divide-gray-100 dark:divide-slate-900 rounded-md bg-white dark:bg-slate-700 shadow-lg shadow-black/50 ring-1 ring-black/5 focus:outline-none z-10'>
