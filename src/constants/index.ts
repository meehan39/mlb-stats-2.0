...
export const LEAGUE_DATA: LeagueData = {
    "matt": {
        ...
        "roster": [{"name": "Pete Alonso", "id": 624413}
    ...
    "alexSap": {
        "teamName": "Alex Sap",
        "roster": [{"name": "Aaron Judge", "id": 592450}
    ...
    "maida": {
        "teamName": "Maida",
        "roster": [{"name": "Shohei Ohtani", "id": 660271}
    ...
    "linardos": {
        "teamName": "Linardos",
        "roster": [{"name": "Kyle Schwarber", "id": 656941}
    ...
    "dylan": {
        "teamName": "Dylan",
        "roster": [{"name": "Juan Soto", "id": 665742}
    ...
    "tony": {
        "teamName": "Tony",
        "roster": [{"name": "Matt Olson", "id": 621566}
    ...
    "mike": {
        ...
        "roster": [{"name": "Ronald Acuña Jr.", "id": 660670}
    ...
    "jv": {
        "teamName": "JV",
        "roster": [{"name": "Yordan Alvarez", "id": 670541}
    ...
    "crog": {
        "teamName": "Crog",
        "roster": [{"name": "Mookie Betts", "id": 605141}
    ...
    "nico": {
        "teamName": "Nico",
        "roster": [{"name": "Adolis García", "id": 666969}
    ...
    "meehan": {
        "teamName": "Shmeez",
        "roster": [{"name": "Marcell Ozuna", "id": 542303}
    ...
    "verdi": {
        "teamName": "Dexter",
        "roster": [{"name": "Vladimir Guerrero Jr.", "id": 665489}
